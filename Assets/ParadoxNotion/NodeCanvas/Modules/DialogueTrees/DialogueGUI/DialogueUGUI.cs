...
namespace NodeCanvas.DialogueTrees.UI.Examples
{
    public class DialogueUGUI : MonoBehaviour, IPointerClickHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData) => mouseLeftButtonDown = true;
        void LateUpdate() => mouseLeftButtonDown = false;
        ...
        IEnumerator Internal_OnSubtitlesRequestInfo(SubtitlesRequestInfo info)
        {
            ...
            if (audio != null)
            {
                ...
                {
                    if (skipOnInput && mouseLeftButtonDown)
                    {
                        playSource.Stop();
                        break;
                    }
